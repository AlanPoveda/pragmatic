defmodule HandlerTest do
  ...
  test "GET /pages/faq" do
    ...
    <ul><li><p><strong>HaveyoureallyseenBigfoot?</strong></p>
    <p>Yes!Inthis<ahref=\"https://www.youtube.com/watch?v=v77ijOO8oAk\">totallybelievablevideo</a>!</p>
    </li><li><p><strong>No,ImeanseenBigfoot<em>ontherefuge</em>?</strong></p>
    <p>Oh!Notyet,butwe’re<em>stilllooking</em>…</p></li><li><p><strong>Canyoujustshowmesomecode?</strong></p>
